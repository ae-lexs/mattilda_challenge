...
### 9.3 Authentication (ADR-008 - Planned)

**Scope:**
- JWT-based authentication (optional enhancement)
- Role-based access control (school admin, staff, parent)
- Protected endpoints with `Depends(get_current_user)`

**See:** [ADR-008: Authentication Strategy](ADR-008-authentication.md) (planned)
...
- [ADR-008: Authentication Strategy](ADR-008-authentication.md) (planned)
