...
- **payments-core ADR-001**: UUID-based identifiers and value object patterns
- **Financial domain best practices**: Decimal arithmetic for monetary values
...
**Consistency**: Same pattern as payments-core ADR-001, proven and validated.

### Pattern

Based on payments-core ADR-001:
